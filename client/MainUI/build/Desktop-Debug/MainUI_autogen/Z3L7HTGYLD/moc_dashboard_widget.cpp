/****************************************************************************
** Meta object code from reading C++ file 'dashboard_widget.h'
**
...
#include "../../../../src/views/dashboard_widget.h"
...
#error "The header file 'dashboard_widget.h' doesn't include <QObject>."
...
Q_CONSTINIT const QMetaObject DashboardWidget::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15DashboardWidgetE_t,
        ...
        // method 'PageChangeCompLists'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'on_CompanyListBtn_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void DashboardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->PageChangeCompLists((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->on_CompanyListBtn_clicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DashboardWidget::*)(int );
            if (_q_method_type _q_method = &DashboardWidget::PageChangeCompLists; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DashboardWidget::PageChangeCompLists(int _t1)
{
